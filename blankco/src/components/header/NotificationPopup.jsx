  ...
  return (
    <div className="notification-popup-wrapper text-left overflow-y-hidden">
      <div
        ...
        className={`absolute right-[0px] top-[81px]  w-[400px] transition-all origin-top  rounded-lg bg-white dark:bg-darkblack-600 overflow-y-hidden ${
      ...
      >
        <div className="relative w-full pb-[75px] pt-[66px] overflow-y-hidden">
          ...
          <ul className="scroll-style-1 h-[335px] w-full overflow-y-scroll">
            <li className="border-b border-bgray-200 py-4 pl-6 pr-[50px] hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
              <a href="#">
            ...
            <li className="border-b border-bgray-200 py-4 pl-6 pr-[50px] hover:bg-bgray-100 dark:border-darkblack-400 dark:hover:bg-darkblack-500">
              <a href="#">
                <div className="noti-item">
                  <p className="mb-1 text-sm font-medium text-bgray-600 dark:text-white">
