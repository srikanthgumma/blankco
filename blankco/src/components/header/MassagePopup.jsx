...
function MassagePopup({ active }) {
  return (
    <div className="message-popup-wrapper text-left">
      <div
        id="message-box"
        style={{
        ...
        className={`absolute right-[0px] top-[81px] transition-all origin-top hidden w-[400px] rounded-lg bg-white dark:bg-darkblack-600 ${
